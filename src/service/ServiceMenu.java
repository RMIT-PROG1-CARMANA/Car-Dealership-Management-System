...
public class ServiceMenu {
    ...
    private static void addPartToService() {
        ...
        if (service != null) {
            ...
            System.out.print("Enter Part Condition: ");
            String condition = scanner.nextLine();

            System.out.print("Enter Warranty: ");
            String warranty = scanner.nextLine();

            double price = getValidDouble("Enter Part Price: ");

            System.out.print("Enter Part Description: ");
            String description = scanner.nextLine();

            AutoPart part = new AutoPart(partID, partName, manufacturer, partNumber, condition, warranty, price, description);
            service.addPartToService(part);
        } else {
            System.out.println("Service not found with ID: " + serviceID);
        }
    }
    ...
    private static void removePartFromService() {
        while (true) {
            ...
            if (service != null) {
                ...
                String partID = scanner.nextLine();
                service.removePartFromService(partID);
                break;
            } else {
                System.out.println("Service not found with ID: " + serviceID);
            }
