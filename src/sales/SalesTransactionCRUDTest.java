...
import static sales.SalesTransactionCRUD.OrderType.discount;
        ...
        while (!exit) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    SalesTransaction newTransaction = new SalesTransaction(transactionID, transactionDate, clientID, PurchasedItem.purchaseItems, discount, totalAmount, notes);
